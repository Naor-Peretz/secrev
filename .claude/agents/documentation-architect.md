...
A stack section used to sit here. It went in the same commit as this sentence,
under H-7: a copy of a binding document is wrong the moment the original moves,
and nothing about a stale copy looks wrong. That matters more for this agent
than most, because documentation that does not match reality is worse than no
documentation — and a doc agent working from a stale copy produces exactly
that, confidently.
