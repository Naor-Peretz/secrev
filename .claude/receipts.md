...
TASK-009B | pending | 74/74 green; transcripts/descripts/foosrc no longer refused, relative+absolute still are; found and fixed 2 `cmd | head` status losses (async-check reported [ok] under a failing pytest; determinism-guard would have announced byte-identical over a failure)
