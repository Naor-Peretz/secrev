...
TASK-004 | pending | 81/81 green; sh/python3 <script> permitted, bash and extension mismatch refused, -c refused; ; && || | newline substitution all refuse beside a protected path; read-only pipeline now refused (asserted cost); relaxing OPERATOR_CHARS turns the gate red
