...
TASK-016 | pending | 88/88 green; MILESTONE M0 -> M1, session-start reports M1 and finds BRIEF_M1.md; a new assertion refuses to let the marker move while any BRIEF_M0.md DoD box is unticked
